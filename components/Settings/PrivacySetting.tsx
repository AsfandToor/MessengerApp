                ...
                <div className="content no-layer">
                    ...
                    <div className="set">
                        <div className="details">
                            ...
                            <p>This settings allows us to use and process information htmlFor analytical purposes.</p>
                        </div>
                        <label className="switch">
                            <input type="checkbox" />
                            <span className="slider round"></span>
                    ...
                    <div className="set">
                        <div className="details">
                            ...
                            <p>This settings allows us to use your information to customize Swipe htmlFor you.</p>
                        </div>
                        <label className="switch">
                            <input type="checkbox" /> 
                            <span className="slider round"></span>
